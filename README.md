...
## Usage
The library exposes two higher order functions: `withProps` and `withStaticProps`. Use them to create new function with additional props assigned to it and to its instances.
